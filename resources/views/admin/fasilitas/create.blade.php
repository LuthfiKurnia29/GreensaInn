...
@section('title', 'Tambah Fasilitas - GreensaInn Admin')
...
<div class="row mb-4">
    <div class="col-12 d-flex align-items-center gap-3">
        ...
        <h4 class="h5 m-0 fw-bold" style="color: var(--primary-color);">Form Tambah Fasilitas</h4>
    </div>
</div>
    ...
    <div class="col-xl-6 col-lg-8">
        <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
            <div class="card-header bg-white border-bottom-0 pt-4 pb-0 px-4">
                <p class="text-muted small mb-0">Isi form di bawah ini untuk menambahkan data fasilitas baru ke dalam sistem.</p>
            </div>
                ...
                <form action="{{ route('admin.fasilitas.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group input-group-lg shadow-sm rounded-3">
                            ...
                            <input type="text" class="form-control border-start-0 ps-0 fs-6 @error('nama_fasilitas') is-invalid @enderror" id="nama_fasilitas" name="nama_fasilitas" value="{{ old('nama_fasilitas') }}" placeholder="Contoh: Proyektor Epson 4K" required>
                        </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group input-group-lg shadow-sm rounded-3">
                            ...
                            <input type="number" class="form-control border-start-0 ps-0 fs-6 fw-bold text-primary @error('stok_tersedia') is-invalid @enderror" id="stok_tersedia" name="stok_tersedia" value="{{ old('stok_tersedia', 0) }}" min="0" required>
